...
//$htmlE = str_replace("/laminas/public/","http://www.lamina.bwtoperadora.com.br/laminas/public/", str_replace("http://www.lamina.bwtoperadora.com.br/laminas/public/", "/laminas/public/", $html) );
$htmlE = str_replace("/laminas/public/","https://lamina.bwtoperadora.com.br/laminas/public/", str_replace("https://lamina.bwtoperadora.com.br/laminas/public/", "/laminas/public/", $html) );
...
*/
function gerarJPG(){
	html2canvas($("#areax")[0]).then(function(canvas) {
		//document.body.appendChild(canvas);
		$("#img").attr("src", canvas.toDataURL("image/jpeg"));	
		  var a = document.createElement('a');			
			a.href = canvas.toDataURL("image/jpeg").replace("image/jpeg", "image/octet-stream");			
...
setTimeout('gerarJPG()', 4500);
</script>

<div id="areax" style="width:800px;background-color:#fff;margin:0 auto"><?php echo str_replace("<br />","",$temp); ?></div>
<div id="result"></div>
